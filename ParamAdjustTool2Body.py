...
class ParameterGUI:
    ...
    def __init__(self, root, xyt_list, masses, charges, param_list):
        ...
        self.m1, self.m2 = [da_to_au*i for i in masses]
        self.q1, self.q2 = charges
    ...
    def plot(self):
        tof1, x1, y1, tof2, x2, y2, delay, adc1, adc2 = self.xyt_list
        ...
        acc1 = self.acc(self.q1, l, z0, self.m1, C) #acceleration of 1st ion
        acc2 = self.acc(self.q2, l, z0, self.m2, C) #acceleration of 2nd ion
